    ...
    function satthi(b){
        if(b==1){
            return (<div key={b} style={bStyle}>
                    <iframe width="540" height="565" src="https://www.youtube.com/embed/KCx-uWtT7ro" title="Realme C55" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>)
        }
        else{
